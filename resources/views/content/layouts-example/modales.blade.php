              ...
              <div class="row">
                <div class="col mb-0">
                  <label for="usuario" class="form-label">Nombre de usuario</label>
                    <input type="text" id="usuario" name="usuario" style="width: 93.5%" class="form-control"
                      value="{{ $inmobiliaria->user->username }}" readonly>
                </div>
          </div>
              <div class="row g-2">
                <div class="col-12">
                  ...
                  <div class="row" style="padding-top: 1.5%" >
                    <div class="col-3" style="padding-right: 5%" >
                      <label for="nombre" class="form-label" >Nombre de la empresa</label>
                      <input type="text" id="nombre" style="width: 105%" name="nombre" class="form-control"
              ...
              <div class="row" style="padding-top: 1.5%">
                    <div class="col mb-0">
                      <label for="direccion" class="form-label">Localización</label>
                        <input type="text" id="direccion" name="direccion" style="width: 93.5%" class="form-control"
