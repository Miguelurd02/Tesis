        ...
        <div class="row mb-5" style="padding-left: 2%">
          ...
          <table id="example" class="ui celled table" style="width:100% ">
            ...
            <tbody>
              ...
              <tr>
                <td>{{$agente->id}}</td>
                <td class="col-2"><img class="img-fluid" src="{{ asset('assets/img/agentes/' . $agente->imagen) }}" alt="Card image cap" /></td>
                <td>{{$agente->nombre}}</td>
                <td>{{$agente->apellido}}</td>
                <td>
                  <center>
                    <button type="button" class="btn btn-icon btn-primary" data-bs-toggle="modal" data-bs-target="#modaldetalle{{$agente->id}}" data-id="{{$agente->id}}">
                      <span class="tf-icons bx bx-detail"></span>
                    </button>
                    <button type="button" class="btn btn-icon btn-primary" data-bs-toggle="modal" data-bs-target="#modaleditar{{$agente->id}}" data-id="{{$agente->id}}">
                      <span class="tf-icons bx bx-edit"></span>
                    </button>
                    <button type="button" class="btn btn-icon btn-primary" data-bs-toggle="modal" data-bs-target="#modalborrar{{$agente->id}}" data-id="{{$agente->id}}">
